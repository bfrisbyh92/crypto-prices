...
const CoinPage = () => {
  ...
  const { watchlist, currency, symbol, user, setAlert } = CryptoState();
        ...
        <div className={classes.marketData}>
          ...
          <span style={{ display: "flex" }}>
            ...
            >
              ...
              {/* ^^^ Amazing that it gives back full description with links to relative information. 100% free no signup API @CoinGecko */}
              M
            </Typography>
          </span>
